...
public class Spawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        poolSize = objectPooler.pools[EnemyTypeNumber(spawnerType)].size;
    ...
    int EnemyTypeNumber(string type)
    {
        if (type == Enum.GetName(typeof(EnemiesAvailable), EnemiesAvailable.DefaultEnemies)){
            return (int)EnemiesAvailable.DefaultEnemies;
        }
        return (int)EnemiesAvailable.DefaultEnemies;
    }
}
